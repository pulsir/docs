...
<p>Describes how we handle your private and public data, what data we collected, and what you can do about it.</p>
</header>
...
<article>
<p>Your privacy is a core Pulsir value. We want to create a policy that you feel good about.</p>

<p>We take protecting your privacy seriously, and we want you to understand exactly how and why we use your information. This document is our Privacy Policy, which describes what information we collect and what it's used for. It applies to all interactions with the Pulsir website, including content posted through mobile apps, widgets and other Pulsir website. Some sites may provide an option to log in with your Pulsir account, in which case their privacy policy and terms apply. Parts of our own policy regulating what data we send, still are valid.</p>

<p>Please read this Privacy Policy carefully. Your use of and/or registration with Pulsir will constitute your agreement to our policy. If you cannot agree to the terms and conditions set forth below, please do not use our services. Additionally, our Privacy Policy is a part of our Terms of Service.</p>

<h3>About this policy</h3>

<p>Pulsir is an open platform that allows you to communicate about anything you want on any topic you want. We collect some information in order for you to have an account you can use to participate on the site, and other information that is necessary to make the service work. Our goal in developing our privacy practices is to allow your participation to remain as anonymous as you choose and we don't sell or profit from the information you share with us.</p>
...
<h3>How we use or disclose collected information</h3>

<p>It takes a lot of work to keep our site running and prevent abuse, but we do not use your data in order to facilitate this. Information you fill in is used internally only where necessary to provide our services.</p>
...
<p>Cookies are small data files placed on your computer by websites you visit in order to help them remember certain information about you. At Pulsir, we set only a few cookies for tracking user preferences and authentication. Each of these uses is described in greater detail below.
When you log into your account, Pulsir will place a few cookies for the sole purpose of creating the session. It contains your username, login time and hashed authentication information. Some preferences, like Dark mode, may be stored using cookies as well.</p>

<p><b>Cookies we use</b><br><p>We try to use as few cookies as possible here, and leave them for as little as needed.  Basically, we use the following cookies:<p>
<p><b>darkmode</b> Set only if you enable Dark Mode and it stays there for a year. </p>
<p><b>plluser</b> When you log in; stays for 3 days. </p>
...
<p>Pulsir is a Croatia-based development team whose servers are housed in the Croatia. All personal information we collect from our international users is transferred to the Croatia and processed according Croatian law.</p>

<p>We welcome users of all ages, but due to COPPA individuals in the US under the age of 14 may not create an account on Pulsir without parental consent which in that case should be sent by email to Pulsir on say.hello@pulsir.eu -- if you believe someone 13 or younger living in US is using our site without parental consent, please contact us by emailing us at say.hello@pulsir.eu</p>

<h3>Changes to this policy</h3>

<p>We reserve the right to change this policy to meet the changing needs of Pulsir, or for any other reason. If we make changes, we will notify our users. Where the changes substantially alters your rights, notice will appear prominently on your front page. More minor changes may be highlighted on the front page footer.</p>
